...
$lang = array(
    ...
    "tagline_desc_2" => "Schnappen Sie sich die epische Beute und fahren Sie los, schnappen Sie sich diese Tropfen, solange Sie können, denn sobald diese Angebote weg sind, sind sie GEGANGEN.",

    "tagline_timer_header" => "Zeit bis zum Schluss",
    "tagline_timer_run" => "Zeit bis zum Schluss",
    "tagline_timer_stop" => "Zeit vor Beginn",
    "tagline_join_social"	=> "Begleiten Sie uns in den sozialen Medien!",
    "tagline_header_end" => "Promotionen sind abgeschlossen",
